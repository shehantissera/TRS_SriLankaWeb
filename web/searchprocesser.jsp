...
<%
    ...
    try {
        ...
        resultItem += "<li><div class='row'><a href='itemview.jsp?id=" + item.getID() + "' class='img span3'><img src='content/product-list-1.png' alt=''></a>"
        ...
        resultItem += "<span class='price-old'>"+searchID+"</span>"
                ...
                + "<a href='itemview.jsp?id=" + item.getID() + "' class='btn btn-primary pull-left'>View Information</a></div></div></div></li>";
